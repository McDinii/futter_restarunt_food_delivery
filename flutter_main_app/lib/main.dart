...
import 'package:flutter_food_delivery_app/data_helper.dart';
...
// Future<void> addDataFromJsonToFirestore() async {
...
//     await collection.add(item).then((docRef) {
...
void main() async {
  ...
  // await addDataFromJsonToFirestore();
